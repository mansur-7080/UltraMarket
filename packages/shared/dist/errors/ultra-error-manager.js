...
exports.ErrorHelpers = exports.errorManager = exports.UltraErrorManager = exports.UltraError = exports.ErrorCode = exports.ErrorCategory = exports.ErrorSeverity = void 0;
...
(function (ErrorCode) {
    ...
    ErrorCode["VALIDATION_FAILED"] = "ERR_1001";
    ErrorCode["INVALID_INPUT"] = "ERR_1002";
    ErrorCode["MISSING_REQUIRED_FIELD"] = "ERR_1003";
    ErrorCode["INVALID_FORMAT"] = "ERR_1004";
    // Authentication errors (2000-2999)
    ErrorCode["AUTHENTICATION_FAILED"] = "ERR_2001";
    ErrorCode["INVALID_CREDENTIALS"] = "ERR_2002";
    ErrorCode["TOKEN_EXPIRED"] = "ERR_2003";
    ErrorCode["TOKEN_INVALID"] = "ERR_2004";
    ErrorCode["MFA_REQUIRED"] = "ERR_2005";
    // Authorization errors (3000-3999)
    ErrorCode["ACCESS_DENIED"] = "ERR_3001";
    ErrorCode["INSUFFICIENT_PERMISSIONS"] = "ERR_3002";
    ErrorCode["ROLE_REQUIRED"] = "ERR_3003";
    ErrorCode["SUBSCRIPTION_REQUIRED"] = "ERR_3004";
    // Database errors (4000-4999)
    ErrorCode["DATABASE_CONNECTION_FAILED"] = "ERR_4001";
    ErrorCode["QUERY_FAILED"] = "ERR_4002";
    ErrorCode["RECORD_NOT_FOUND"] = "ERR_4003";
    ErrorCode["DUPLICATE_ENTRY"] = "ERR_4004";
    ErrorCode["CONSTRAINT_VIOLATION"] = "ERR_4005";
    ErrorCode["TRANSACTION_FAILED"] = "ERR_4006";
    // External API errors (5000-5999)
    ErrorCode["EXTERNAL_SERVICE_UNAVAILABLE"] = "ERR_5001";
    ErrorCode["API_RATE_LIMIT_EXCEEDED"] = "ERR_5002";
    ErrorCode["THIRD_PARTY_ERROR"] = "ERR_5003";
    ErrorCode["PAYMENT_GATEWAY_ERROR"] = "ERR_5004";
    // Business logic errors (6000-6999)
    ErrorCode["BUSINESS_RULE_VIOLATION"] = "ERR_6001";
    ErrorCode["INSUFFICIENT_INVENTORY"] = "ERR_6002";
    ErrorCode["ORDER_PROCESSING_ERROR"] = "ERR_6003";
    ErrorCode["PRICE_CALCULATION_ERROR"] = "ERR_6004";
    // System errors (7000-7999)
    ErrorCode["INTERNAL_SERVER_ERROR"] = "ERR_7001";
    ErrorCode["SERVICE_UNAVAILABLE"] = "ERR_7002";
    ErrorCode["CONFIGURATION_ERROR"] = "ERR_7003";
    ErrorCode["MEMORY_LIMIT_EXCEEDED"] = "ERR_7004";
    // Network errors (8000-8999)
    ErrorCode["NETWORK_ERROR"] = "ERR_8001";
    ErrorCode["TIMEOUT_ERROR"] = "ERR_8002";
    ErrorCode["CONNECTION_REFUSED"] = "ERR_8003";
    // Performance errors (9000-9999)
    ErrorCode["SLOW_QUERY"] = "ERR_9001";
    ErrorCode["HIGH_MEMORY_USAGE"] = "ERR_9002";
    ErrorCode["CPU_OVERLOAD"] = "ERR_9003";
    // Security errors (10000-10999)
    ErrorCode["SECURITY_VIOLATION"] = "ERR_10001";
    ErrorCode["SUSPICIOUS_ACTIVITY"] = "ERR_10002";
    ErrorCode["XSS_ATTEMPT"] = "ERR_10003";
    ErrorCode["SQL_INJECTION_ATTEMPT"] = "ERR_10004";
})(ErrorCode || (exports.ErrorCode = ErrorCode = {}));
/**
 * Ultra Professional Error Class
 * Enhanced error with comprehensive metadata
 */
class UltraError extends Error {
    details;
    timestamp;
    errorId;
    constructor(details) {
    ...
    getCategoryFromCode(code) {
        ...
        if (codeNum >= 10000 && codeNum < 11000)
...
exports.UltraError = UltraError;
/**
 * Ultra Error Manager
 * Centralized error handling and monitoring system
 */
class UltraErrorManager extends events_1.EventEmitter {
    ...
    async handleError(error, context) {
        try {
            ...
            ultra_professional_logger_1.logger.error('❌ Error in error handling system', handlingError);
            return {
    ...
    async retryOperation(operation, options = {}) {
        ...
        for (let attempt = 0; attempt <= maxRetries; attempt++) {
            try {
                ...
                ultra_professional_logger_1.logger.warn(`🔄 Retrying operation (attempt ${attempt + 1}/${maxRetries}) after ${delay}ms`, {
     ...
     */
    async circuitBreaker(key, operation, options = {}) {
        ...
        if (circuitState.isOpen && Date.now() - circuitState.lastFailure.getTime() > timeout) {
            ...
            ultra_professional_logger_1.logger.info(`🔄 Circuit breaker ${key} reset to closed state`);
        }
        ...
        if (circuitState.isOpen) {
            ...
            throw this.createError(ErrorCode.SERVICE_UNAVAILABLE, `Service ${key} is temporarily unavailable (circuit breaker open)`, {
        ...
        try {
            ...
            if (circuitState.failures > 0) {
                circuitState.failures = 0;
                ultra_professional_logger_1.logger.info(`✅ Circuit breaker ${key} reset failure count`);
            }
            return result;
        }
        catch (error) {
            ...
            if (circuitState.failures >= failureThreshold) {
                ...
                ultra_professional_logger_1.logger.warn(`🚨 Circuit breaker ${key} opened due to ${circuitState.failures} failures`);
     ...
     */
    convertToUltraError(error, context) {
    ...
    logError(error) {
        ...
        switch (error.details.severity) {
            case ErrorSeverity.CRITICAL:
                ultra_professional_logger_1.logger.error('🚨 CRITICAL ERROR', logData);
                break;
            case ErrorSeverity.HIGH:
                ultra_professional_logger_1.logger.error('❌ HIGH SEVERITY ERROR', logData);
                break;
            case ErrorSeverity.MEDIUM:
                ultra_professional_logger_1.logger.warn('⚠️ MEDIUM SEVERITY ERROR', logData);
                break;
            case ErrorSeverity.LOW:
                ultra_professional_logger_1.logger.info('ℹ️ LOW SEVERITY ERROR', logData);
                break;
        }
    }
    /**
    ...
    async attemptRecovery(error) {
        ...
        try {
            ...
            ultra_professional_logger_1.logger.error('❌ Error recovery failed', recoveryError);
     ...
     */
    async checkAlertConditions(errorDetails) {
        ...
        const recentHighSeverityErrors = this.errors.filter(e => e.severity === ErrorSeverity.HIGH &&
    ...
    setupGlobalErrorHandlers() {
        ...
        if (typeof process !== 'undefined') {
            ...
            process.on('uncaughtException', (error) => {
                ...
                ultra_professional_logger_1.logger.error('🚨 Uncaught exception - process may need to restart', error);
            });
        }
    }
    /**
...
exports.UltraErrorManager = UltraErrorManager;
/**
 * Global error manager instance
 */
exports.errorManager = UltraErrorManager.getInstance();
/**
...
exports.ErrorHelpers = {
     ...
     */
    validation: (message, field, value) => exports.errorManager.createError(ErrorCode.VALIDATION_FAILED, message, {
        severity: ErrorSeverity.LOW,
        context: { field, value }
    }),
    /**
     ...
     */
    authentication: (message = 'Authentication failed') => exports.errorManager.createError(ErrorCode.AUTHENTICATION_FAILED, message, {
        severity: ErrorSeverity.HIGH
    }),
    /**
     * Create authorization error
     */
    authorization: (message = 'Access denied') => exports.errorManager.createError(ErrorCode.ACCESS_DENIED, message, {
        severity: ErrorSeverity.MEDIUM
    }),
    /**
     * Create database error
     */
    database: (message, query) => exports.errorManager.createError(ErrorCode.QUERY_FAILED, message, {
        severity: ErrorSeverity.HIGH,
        context: { query }
    }),
    /**
     ...
     */
    business: (message, context) => exports.errorManager.createError(ErrorCode.BUSINESS_RULE_VIOLATION, message, {
        severity: ErrorSeverity.MEDIUM,
        context
    })
};
//# sourceMappingURL=ultra-error-manager.js.map