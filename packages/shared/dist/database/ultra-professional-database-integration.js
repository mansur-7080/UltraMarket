...
exports.UltraProfessionalDatabaseOptimizer = exports.cacheServiceHelper = exports.orderServiceDB = exports.userServiceDB = exports.productServiceDB = exports.CacheServiceHelper = exports.OrderServiceDB = exports.UserServiceDB = exports.ProductServiceDB = exports.productionDatabaseConfig = void 0;
...
const ultra_professional_database_optimizer_1 = require("./ultra-professional-database-optimizer");
Object.defineProperty(exports, "UltraProfessionalDatabaseOptimizer", { enumerable: true, get: function () { return ultra_professional_database_optimizer_1.UltraProfessionalDatabaseOptimizer; } });
 ...
 */
async function initializeDatabaseOptimizer(config = exports.productionDatabaseConfig) {
    try {
        if (databaseOptimizer) {
            ultra_professional_logger_1.logger.warn('🔄 Database optimizer already initialized, returning existing instance');
            return databaseOptimizer;
        }
        ultra_professional_logger_1.logger.info('🚀 Initializing Ultra Professional Database Optimizer');
        databaseOptimizer = (0, ultra_professional_database_optimizer_1.createDatabaseOptimizer)(config);
        // Setup graceful shutdown
        setupGracefulShutdown();
        ultra_professional_logger_1.logger.info('✅ Database optimizer initialized successfully');
        return databaseOptimizer;
    }
    catch (error) {
        ultra_professional_logger_1.logger.error('❌ Failed to initialize database optimizer', error);
...
class ProductServiceDB {
    ...
    async searchProducts(searchTerm, options = {}) {
        return this.optimizer.executeMongoOperation('products', async (collection) => {
            const pipeline = [
                {
                    $match: {
                        $and: [
...
exports.ProductServiceDB = ProductServiceDB;
/**
...
exports.UserServiceDB = UserServiceDB;
/**
...
exports.OrderServiceDB = OrderServiceDB;
/**
...
class CacheServiceHelper {
    ...
    async get(key) {
        try {
            return await this.optimizer.executeRedisOperation(async (client) => {
    ...
    async set(key, value, ttlSeconds = 3600) {
        try {
            await this.optimizer.executeRedisOperation(async (client) => {
    ...
    async clearPattern(pattern) {
        try {
            ...
            ultra_professional_logger_1.logger.error('❌ Cache clear pattern failed', error, { pattern });
            return 0;
        }
    }
}
exports.CacheServiceHelper = CacheServiceHelper;
/**
 * Setup graceful shutdown for database connections
 */
function setupGracefulShutdown() {
    const shutdown = async (signal) => {
        ultra_professional_logger_1.logger.info(`🛑 ${signal} received, shutting down database connections...`);
        if (databaseOptimizer) {
            try {
    ...
    return (req, res, next) => {
        ...
        res.on('finish', () => {
            ...
            if (databaseOptimizer) {
                ...
                // Log slow requests
                if (duration > 1000) {
                    ultra_professional_logger_1.logger.warn('🐌 Slow request detected', {
                        method: req.method,
                        url: req.url,
                        duration,
...
exports.productServiceDB = new ProductServiceDB();
exports.userServiceDB = new UserServiceDB();
exports.orderServiceDB = new OrderServiceDB();
exports.cacheServiceHelper = new CacheServiceHelper();
// Export performance monitoring endpoint
function getDatabasePerformanceReport() {
    if (!databaseOptimizer) {
        return { error: 'Database optimizer not initialized' };
    }
    return databaseOptimizer.getPerformanceMetrics();
}
//# sourceMappingURL=ultra-professional-database-integration.js.map