...
exports.swaggerUIOptions = exports.serviceConfigs = exports.baseSwaggerConfig = void 0;
exports.generateSwaggerDocs = generateSwaggerDocs;
// =================== SWAGGER CONFIGURATION ===================
/**
 * Base Swagger configuration for all services
 */
exports.baseSwaggerConfig = {
    definition: {
        openapi: '3.0.3',
        info: {
...
exports.serviceConfigs = {
    'auth-service': {
        ...exports.baseSwaggerConfig,
        definition: {
            ...exports.baseSwaggerConfig.definition,
            info: {
                ...exports.baseSwaggerConfig.definition.info,
 ...
 */
function generateSwaggerDocs(serviceName) {
    const config = exports.serviceConfigs[serviceName];
    if (!config) {
...
exports.default = {
    baseSwaggerConfig: exports.baseSwaggerConfig,
    serviceConfigs: exports.serviceConfigs,
    swaggerUIOptions: exports.swaggerUIOptions,
    generateSwaggerDocs,
};
