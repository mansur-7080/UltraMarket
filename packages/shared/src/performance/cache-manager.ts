...
export const cacheStrategies = {
  ...
  cacheAll: {
    name: 'cache-all',
    shouldCache: () => true,
    getTTL: (_key: string, _value: unknown) => 3600, // 1 hour
  ...
  cacheSuccess: {
    name: 'cache-success',
    shouldCache: (_key: string, value: unknown) => {
      return value !== null && value !== undefined && (value as any).error === undefined;
    },
    getTTL: (_key: string, _value: unknown) => 1800, // 30 minutes
    getKey: (originalKey: string) => originalKey,
  },
  ...
  cacheByUser: {
    name: 'cache-by-user',
    shouldCache: () => true,
    getTTL: (_key: string, _value: unknown) => 900, // 15 minutes
  ...
  cacheExpensive: {
    ...
    getTTL: (_key: string, _value: unknown) => 7200, // 2 hours
