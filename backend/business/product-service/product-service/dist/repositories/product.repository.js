...
exports.productRepository = {
    ...
    async findById(id, includeDeleted = false) {
        try {
            ...
            logger_1.logger.error('Error finding product by ID', { id, error: error.message });
    ...
    async findBySku(sku) {
        try {
            ...
            logger_1.logger.error('Error finding product by SKU', { sku, error: error.message });
    ...
    async findByField(field, value) {
        try {
            ...
            logger_1.logger.error(`Error finding product by ${field}`, { field, value, error: error.message });
    ...
    async findMany(options) {
        try {
            const { skip = 0, take = 20, where = {}, orderBy = { createdAt: 'desc' }, includeDeleted = false, } = options;
            ...
            logger_1.logger.error('Error finding products', { options, error: error.message });
    ...
    async count(where = {}, includeDeleted = false) {
        try {
            ...
            return await prisma_1.default.product.count({ where });
        }
        catch (error) {
            logger_1.logger.error('Error counting products', { where, error: error.message });
    ...
    async create(data) {
        try {
            ...
            logger_1.logger.error('Error creating product', { error: error.message });
    ...
    async update(id, data) {
        try {
            ...
            logger_1.logger.error('Error updating product', { id, error: error.message });
    ...
    async softDelete(id) {
        try {
            ...
            logger_1.logger.error('Error soft-deleting product', { id, error: error.message });
    ...
    async hardDelete(id) {
        try {
            ...
            logger_1.logger.error('Error hard-deleting product', { id, error: error.message });
    ...
    async bulkUpdateStock(updates) {
        ...
        try {
            ...
            logger_1.logger.error('Error bulk updating product stock', { error: error.message });
    ...
    async search(query, options) {
        try {
            ...
            logger_1.logger.error('Error searching products', { query, error: error.message });
     ...
     */
    async getFeatured(categoryId, limit = 10) {
        try {
            const where = {
                isFeatured: true,
                isDeleted: false,
            ...
            logger_1.logger.error('Error fetching featured products', { categoryId, error: error.message });
     ...
     */
    async getRelated(productId, category, tags, limit = 8) {
        try {
            ...
            if (products.length < limit) {
                const additionalProducts = await prisma_1.default.product.findMany({
                    where: {
                        id: { not: productId },
                        category,
                        isDeleted: false,
            ...
            logger_1.logger.error('Error fetching related products', {
                productId,
                category,
                error: error.message,
            });
    ...
    async findLowStock(threshold = 10) {
        try {
            ...
            logger_1.logger.error('Error finding low stock products', { threshold, error: error.message });
